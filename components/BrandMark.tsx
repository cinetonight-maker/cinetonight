...
export default function BrandMark({ size = 30 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" aria-hidden="true" focusable="false">
      ...
      <path d="M52 36 L52 64 L76 50 Z" fill="var(--accent-d, #8f1220)" stroke="var(--accent-d, #8f1220)" strokeWidth="16" strokeLinejoin="round" />
      {/* front play triangle - brand red, rounded via round join */}
      <path d="M40 34 L40 66 L68 50 Z" fill="var(--accent2, #ff3b48)" stroke="var(--accent2, #ff3b48)" strokeWidth="16" strokeLinejoin="round" />
